...
<body>
	...
	<section class="main-section">
		...
		<table class="table table-bordered">
			...
			<tr>
				...
				<td>
					...
					<a href="/myapp/notice/view.do?seq=${ dto.seq }&column=${ map.column }&search=${ map.search }">${ dto.subject }</a>
		...
		<div class="btns">
			...
			<button type="button" class="btn btn-primary"
				onclick="location.href='/myapp/notice/add.do?reply=0';">글쓰기</button>
			</c:if>
			
			<button type="button" class="btn btn-default"
				onclick="location.href='/myapp/notice/list.do';">새로고침</button>
		</div>
		...
		<div class="searchbox">
			...
			-->
			<form method="GET" action="/myapp/notice/list.do">
	...
	<script>
		...
		$( '#selPage' ).change(function() {
			...
			location.href = '/myapp/notice/list.do?page=' + $(this).val();
		});
